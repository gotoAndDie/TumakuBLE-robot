...
public class HM10Activity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		FloatingTouchEventView controls = (FloatingTouchEventView) findViewById(R.id.drawing);
    ...
    public void sendCoord(String content)
    {
        mTumakuBLE.write(TumakuBLE.SENSORTAG_KEY_SERVICE,TumakuBLE.SENSORTAG_KEY_DATA, content);
    }
}
